...
import Amogh from '../Images/nav-icon.png';
        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center mt-2 space-x-3 rtl:space-x-reverse">
                    <img src={Amogh} className="h-10" alt="Flowbite Logo" />
                </a>
                <button
                    type="button"
                ...
                <div
                    className={`w-full md:block md:w-auto transform transition-transform duration-300 ease-in-out ${
                        isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 md:max-h-full md:opacity-100'
                    } overflow-hidden`}
                    id="navbar-default"
                >
