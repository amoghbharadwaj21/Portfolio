    ...
    return (
        <section id="testimonials" className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                <div className="grid grid-cols-1 gap-8 mt-10 sm:grid-cols-2 sm:gap-12">
                    {/* Raghuveer Bhat's Testimonial */}
                    <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-2 border-transparent rounded-lg md:p-12 dark:bg-gray-800 dark:border-transparent hover:border-blue-500 dark:hover:border-blue-300 transition-colors w-full">
