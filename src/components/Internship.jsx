...
function Internship() {
    return (
        <section id="internship" className="bg-white dark:bg-gray-900 antialiased">
            <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="mt-4 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400">
                        Here's a look at my internships and contributions
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12 text-center">
                    ...
                    <div className="p-6 bg-white border-2 border-transparent rounded-lg shadow-md dark:bg-gray-800 dark:border-transparent hover:border-blue-500 dark:hover:border-blue-300 transition-colors">
                        ...
                        <p className="mt-4 text-base font-normal text-gray-500 dark:text-gray-400 text-justify">
                            Designed and implemented RESTful APIs with strong input validation and structured request handling, ensuring robustness and data integrity. Built modular, maintainable backend services and containerized applications for consistent deployment. Completed an intensive traineeship, achieving an A+ grade and demonstrating strong technical proficiency.
                        </p>
                    ...
                    {/* Government Tool Room and Training Centre Card */}
                    <div className="p-6 bg-white border-2 border-transparent rounded-lg shadow-md dark:bg-gray-800 dark:border-transparent hover:border-blue-500 dark:hover:border-blue-300 transition-colors">
